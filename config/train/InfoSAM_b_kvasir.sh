...
TEST_SEQ_PATH="test_Kvasir.csv"
MODEL_BASE_PATH="exp_infoSAM/kvasir"
TRAIN_MODEL_PATH="$MODEL_BASE_PATH/train/InfoSAM_b_kvasir"
TEST_MODEL_PATH="$MODEL_BASE_PATH/test/InfoSAM_b_kvasir"
